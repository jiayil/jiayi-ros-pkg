...
rawDataMe = importdata('../../tracking_mapping/data/UCSB/fi_bu_zm');
rawDataGt = importdata('../../tracking_mapping/data/UCSB/fi_bu_zm_gt');
...
angRange = dataGt(1:lenData, 3)*100;
...
title({'\makebox[4in][c]{Z Axis Translation (60 to 140cm)}',...

...
% load t_m data/UCSB/fi_bu_rt
rawDataMe = importdata('../../tracking_mapping/data/UCSB/fi_bu_rt');
rawDataGt = importdata('../../tracking_mapping/data/UCSB/fi_bu_rt_gt');
...
angRange = roundAround180(dataGt(1:lenData, 6));
angRange = angRange + 90;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
title({'\makebox[4in][c]{Z Axis Rotation (-100$^\circ$ to 0)}',...
